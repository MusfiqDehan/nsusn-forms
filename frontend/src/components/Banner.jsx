    ...
    <div className="hero flex min-h-screen flex-col items-center justify-center">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="w-1/2 text-center lg:ml-10 lg:text-left">
          ...
          <a
            href="#apply-now"
            className="btn bg-purple-900 px-10 text-2xl text-white transition-all duration-300 ease-in-out hover:scale-105 hover:bg-purple-800 hover:px-11 hover:shadow-xl"
          >
            Apply Now!
          </a>
        </div>
